...
axes[1].plot(device.inertial.timestamp, device.inertial.gyroscope.x, "tab:red", label="X")
axes[1].plot(device.inertial.timestamp, device.inertial.gyroscope.y, "tab:green", label="Y")
axes[1].plot(device.inertial.timestamp, device.inertial.gyroscope.z, "tab:blue", label="Z")
